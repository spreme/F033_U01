...
void ADCInit(void)
{
	...
	*/
	...
	ADC1_ConfigRunMode(ADC1_CONVERT_SINGLE,ADC1_CLK_DIV_8,ADC1_HOLD_10P5_CLK);			/*使能单通道转换*/

	/*
	(2)设置ADC1通道使能
	*/	
	ADC1_EnableScanChannel(ADC1_CH_0_MSK);						/*ADC1_CH_13_MSK  触发的通道选择AN0 */	
	SYS_SET_IOCFG(IOP00CFG,SYS_IOCFG_P00_AN0);					/*关闭P0的数字功能*/
	
//	/*
//	(4)设置ADC1中断
//	*/		
//	
//	ADC1_EnableChannelInt(ADC1_CH_0_MSK);						/*开AN0转换中断*/	
